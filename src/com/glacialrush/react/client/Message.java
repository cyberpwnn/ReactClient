...
public class Message extends JDialog
{
	...
	public static void error(String title, String message, boolean eoc)
	{
		try
		{
			Message dialog = new Message(title, message, eoc);
	...
	public Message(String title, String message, boolean eoc)
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(Message.class.getResource("/com/glacialrush/react/icon.png")));
		setAlwaysOnTop(true);
		setTitle(title);
		setBounds(100, 100, 485, 371);
