...
public class ServerTab implements ListSelectionListener, ActionListener {
    ...
    private final JLabel lblTps;
    private final JLabel lblMbUsed;
    private final JLabel lblGcminute;
    private final JLabel lblMahs;
    private final JLabel lblUsingSpigot;
    private final JLabel lblOnline;
    private final JLabel lblmsPing;
    ...
    private final DefaultListModel<String> actionList;

    private final JXTabbedPane tabbedPane;
    private final JPanel panel;

    private final Grapher TPS;
    private final GList<Double> DTPS;

    private final Grapher MEM;
    private final GList<Double> DMEM;

    private final Grapher GC;
    private final GList<Double> DGC;

    private final Grapher MAH;
    private final GList<Double> DMAH;
    private final GList<Double> DCUSTOM;
    ...
    public ServerTab(JFrame frame, NetworkedServer server, JXTabbedPane tp) {
        ...
        actionSet.addListSelectionListener(this);
